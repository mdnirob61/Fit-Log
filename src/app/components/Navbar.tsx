        ...
        <nav className="sticky top-0 z-50 w-full border-b border-[#202227] bg-black">
            <div className="flex h-20 items-center justify-between container mx-auto">
                ...
                <div className="absolute left-1/2 flex -translate-x-1/2 items-center gap-3">
                    <Link
                        href="/"
                        className={`rounded-full px-4 py-1.5 text-[0.8rem] font-medium transition ${pathname === "/"
                    ...
                    <Link
                        href="/my-plan"
                        className={`rounded-full px-4 py-1.5 text-[0.8rem] font-medium transition ${pathname === "/my-plan"
                            ? "bg-[#ccff00] text-black"
                            : "text-[#8b8d91] hover:text-white"
                            }`}>
                        My Plan
